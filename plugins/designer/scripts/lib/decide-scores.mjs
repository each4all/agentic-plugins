...
// recommendation for /designer:decide (ADR-0027 §1.3 invariant + PR4 Task 4).
//
...
//
// designer copy-adapt note (ADR-0029): decide-scores is a domain-agnostic
// pure lib, so this designer copy carries NO hardcoded persona axis — ties
