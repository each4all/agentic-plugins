...
// routing utilities for the designer plugin (ADR-0028 §Centralization pattern, copy-trimmed per ADR-0042 SD7).
//
...
//
// stop-archive.mjs and plugins/designer/adapters/claude/hooks/_shared.mjs
