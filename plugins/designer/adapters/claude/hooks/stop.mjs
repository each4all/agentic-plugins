...
//
// Claude Code Stop hook for the designer plugin per ADR-0011 §4 +
...
async function main() {
  ...
  if (active) {
    try {
      ...
      process.stderr.write(`designer/stop: ${err.message}\n`);
    }
  }
  ...
  try {
    ...
    process.stderr.write(`designer/stop orphan-sweep: ${err.message}\n`);
  }
  return 0;
}
