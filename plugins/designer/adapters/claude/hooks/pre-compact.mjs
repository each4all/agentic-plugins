#!/usr/bin/env node
// plugins/designer/adapters/claude/hooks/pre-compact.mjs
//
// Claude Code PreCompact hook for the designer plugin per ADR-0011 §4.
...
async function main() {
  ...
  try {
    ...
    process.stderr.write(`designer/pre-compact: ${err.message}\n`);
  }
  return 0;
}
