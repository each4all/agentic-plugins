...
The designer Codex manifest exposes `./adapters/codex/hooks/hooks.json`, so
...
- `session-start.mjs` — emits the same `[designer-active-metadata]`
...
whether the designer manifest exposes hooks, and
