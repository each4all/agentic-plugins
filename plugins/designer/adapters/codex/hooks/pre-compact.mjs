...
//
// Codex plugin PreCompact hook for the designer plugin. Mirrors the Claude
...
import { gitStatusDigest, gitTopLevel, readStdinJson } from './_shared.mjs';
...
async function main() {
  ...
  try {
    ...
    process.stderr.write(`designer/codex-pre-compact: ${err.message}\n`);
  }
  return 0;
}
