#!/usr/bin/env node
// plugins/designer/adapters/codex/hooks/session-start.mjs
//
// Codex plugin SessionStart hook for the designer plugin. Mirrors the Claude
// metadata reinjection payload plus the ADR-0043 S4 pending-handoff backstop
// (best-effort; its only write is consuming designer's own one-shot handoff
...
import { gitTopLevel, readStdinJson } from './_shared.mjs';
