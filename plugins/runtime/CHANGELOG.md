...
* **plugin/runtime:** relocate skills under core/ ([1b6f2e5](https://github.com/each4all/agentic-plugins/commit/1b6f2e59ac3696a7ac62a09d19170b72e063a161))
...
* **runtime:** make Codex read the cutover skill's invocation policy ([#777](https://github.com/each4all/agentic-plugins/issues/777)) ([7213a7c](https://github.com/each4all/agentic-plugins/commit/7213a7c3005017e702027b2d0dee2d1dbc0c5441))

## [0.97.1](https://github.com/each4all/agentic-plugins/compare/plugin-runtime-v0.97.0...plugin-runtime-v0.97.1) (2026-08-28)


### Bug Fixes

* **plugin/runtime:** refresh host parity baseline to Claude 2.1.250 / Codex 0.150.1 ([#755](https://github.com/each4all/agentic-plugins/issues/755)) ([97d7f64](https://github.com/each4all/agentic-plugins/commit/97d7f643a905c30ce7fa72ab66a85c62481a79a8))
...
* **plugin/runtime:** a value-carrying bootstrap interview for the session family and notify_kinds ([#739](https://github.com/each4all/agentic-plugins/issues/739)) ([f795085](https://github.com/each4all/agentic-plugins/commit/f79508505ee21fdc36e34e04a611573cca2be8e2))


### Bug Fixes

* **plugin/runtime:** hand the raw readers to the pre-sanitize secret gate ([#737](https://github.com/each4all/agentic-plugins/issues/737)) ([3c22185](https://github.com/each4all/agentic-plugins/commit/3c22185a8ef609c3d21f94dd4d49ecb4a928c469))
...
* **plugin/runtime:** the first assurance grant, and the R1 assertions it replaces ([#716](https://github.com/each4all/agentic-plugins/issues/716)) ([592fa1a](https://github.com/each4all/agentic-plugins/commit/592fa1acc4e86949fdb8df69dd4f594e1aec9949))

## [0.91.1](https://github.com/each4all/agentic-plugins/compare/plugin-runtime-v0.91.0...plugin-runtime-v0.91.1) (2026-08-18)


### Bug Fixes

* **plugin/runtime:** close the false-assurance paths ST5 reproduced, including the mirrors the first fix left ([4ee8764](https://github.com/each4all/agentic-plugins/commit/4ee876459c90513a8004fc5c51e7e7688b919316))
...
* **plugin/runtime:** refresh host parity baseline to Claude 2.1.233 ([2eea2b3](https://github.com/each4all/agentic-plugins/commit/2eea2b3dd95459d88dda915d4f39c4f2399e1eab))
...
* **plugin/runtime:** refresh host-parity baseline to Claude Code 2.1.227 ([354a95d](https://github.com/each4all/agentic-plugins/commit/354a95d40dd8b3aad396c110770194382e70820b))

## [0.90.0](https://github.com/each4all/agentic-plugins/compare/plugin-runtime-v0.89.0...plugin-runtime-v0.90.0) (2026-08-10)


### Features

* **plugin/runtime:** packaged host-parity baseline as the single authority (ADR-0051) ([#685](https://github.com/each4all/agentic-plugins/issues/685)) ([20ebed7](https://github.com/each4all/agentic-plugins/commit/20ebed7421408a16ddb7387aed7829ffbb9f8c39))
...
* **plugin/runtime:** spend the evidence budget per reason, and render what the profile verbs computed ([#665](https://github.com/each4all/agentic-plugins/issues/665)) ([0d46223](https://github.com/each4all/agentic-plugins/commit/0d462234945e9156ee8506bf9f74d8ba2a01c440))
...
* **plugin/runtime:** let a machine record host-native model/effort as its posture ([167fd4a](https://github.com/each4all/agentic-plugins/commit/167fd4a79d61a757550eef165fc8ac00654c3025))


### Bug Fixes

* **plugin/runtime:** narrow the effective selection when a plugin is declined ([3b75915](https://github.com/each4all/agentic-plugins/commit/3b759155aedf0eba2f8a644786356dc2aab30ce0))

## [0.86.3](https://github.com/each4all/agentic-plugins/compare/plugin-runtime-v0.86.2...plugin-runtime-v0.86.3) (2026-07-28)


### Bug Fixes

* **plugin/runtime:** read the Codex /hooks attestation from the path doctor emits, and judge it by selection ([b55ce53](https://github.com/each4all/agentic-plugins/commit/b55ce5363442e8e337ae50f7d8e094113cc4e957))

## [0.86.2](https://github.com/each4all/agentic-plugins/compare/plugin-runtime-v0.86.1...plugin-runtime-v0.86.2) (2026-07-25)


### Bug Fixes

* **plugin/runtime:** egress-proof opt-in from provenance, not the derived row ([af620df](https://github.com/each4all/agentic-plugins/commit/af620df40d54f385f933923ad0004a3962babb33))
* **plugin/runtime:** render Stage-8 proofs once from the reducer — control vs evidence ([c549ed2](https://github.com/each4all/agentic-plugins/commit/c549ed281d16fc2410e492233af8ed4c0cfb5460))
...
* **plugin/runtime:** prerelease tie-break + build-metadata strip in shared semverCompare (§18 comparator follow-up) ([ba1c201](https://github.com/each4all/agentic-plugins/commit/ba1c20127541b65c93772ee317330511a78be4f9))
