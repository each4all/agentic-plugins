...
Observed on 2026-07-11 with Claude Code `2.1.207`, Codex CLI
...
Local CLI evidence (version probe re-observed 2026-07-11 for the Claude
`2.1.207` patch drift — `claude plugin --help` / `claude mcp --help`
