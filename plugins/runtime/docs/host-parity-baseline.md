...
Observed on 2026-07-10 with Claude Code `2.1.206`, Codex CLI
...
Local CLI evidence (re-observed 2026-07-10; earlier refreshes updated the
header and appended history rows while leaving this block at
`2.1.173`/`0.139.0` — repaired here):
