...
* **plugin/orchestrator:** resolve companions from the caller's own install cache ([#810](https://github.com/each4all/agentic-plugins/issues/810)) ([6eb0f5c](https://github.com/each4all/agentic-plugins/commit/6eb0f5c9d9727742e6defedf92ec152da8dc4280))
* **plugin/orchestrator:** resolve siblings from the caller's own install cache ([#812](https://github.com/each4all/agentic-plugins/issues/812)) ([cba93ac](https://github.com/each4all/agentic-plugins/commit/cba93acff1432875160f8e23e94f99e648f59b82))

## [0.13.7](https://github.com/each4all/agentic-plugins/compare/plugin-orchestrator-v0.13.6...plugin-orchestrator-v0.13.7) (2026-09-22)


### Bug Fixes

* **plugin/orchestrator:** relocate skills under core/ ([b9c63a5](https://github.com/each4all/agentic-plugins/commit/b9c63a5a7639a56e2cb35b30bffc435bed0fcdc2))

## [0.13.6](https://github.com/each4all/agentic-plugins/compare/plugin-orchestrator-v0.13.5...plugin-orchestrator-v0.13.6) (2026-09-22)


### Bug Fixes

* **plugin/orchestrator:** point a shipped reference at engineer's relocated root ([d7ce2b8](https://github.com/each4all/agentic-plugins/commit/d7ce2b8449964c0e2e5a6debd40068016d1128f8))
...
* **plugin/orchestrator:** scope checkpoint and resume re-injection to post-compact ([20cb629](https://github.com/each4all/agentic-plugins/commit/20cb6290e0af9dc4ebc824a9e639a9e1ff4b23a2))
...
* **plugin/orchestrator:** register peer-runner child observers synchronously with spawn ([faad7c9](https://github.com/each4all/agentic-plugins/commit/faad7c9c9749300a28762c26af6b2fce8869144f))
