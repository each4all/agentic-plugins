#!/usr/bin/env node
// plugins/engineer/adapters/claude/hooks/pre-compact.mjs
//
// Claude Code PreCompact hook for the engineer plugin per ADR-0011 §4.
...
async function main() {
  ...
  try {
    ...
    process.stderr.write(`engineer/pre-compact: ${err.message}\n`);
  }
  return 0;
}
