...
// the runtime peer and gated on a minimum runtime version.
//
...
export async function locateRuntimePluginRoot({
  ...
  // <engineer-root>/scripts/discover-runtime.mjs → <engineer-root>/../runtime.
...
function reportCrossHostFallback(located, stderr) {
  ...
  try {
    stderr.write(
      `engineer/discover-runtime: runtime resolved from the ${located.host} plugin cache ` +
