// Weights normalization for /engineer:decide (ADR-0027 §5.6 + PR4 Task 2).
//
...
//   for weighting" — we never emit `{essence: 1, ...}` to mean uniform
//   because that would look identical to an explicit `--weights=essence:1`.
//
// Fill rule (peer G6):
