...
// routing utilities for the founder plugin (ADR-0028 §Centralization pattern, copy-trimmed per ADR-0036 SD7).
//
...
//
// stop-archive.mjs and plugins/founder/adapters/claude/hooks/_shared.mjs
