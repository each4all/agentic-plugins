...
//
// Codex-side Stop helper for the founder plugin per ADR-0011 §4 +
...
async function main() {
  ...
  if (active) {
    ...
    try {
      ...
      process.stderr.write(`founder/codex-stop handoff-backstop: ${err.message}\n`);
    }
    try {
      ...
      process.stderr.write(`founder/codex-stop: ${err.message}\n`);
    }
  }
  ...
  try {
    ...
    process.stderr.write(`founder/codex-stop orphan-sweep: ${err.message}\n`);
  }
  return 0;
}
