// plugins/designer/scripts/dispatch-peer.mjs unit tests (Stage 2
...
//
// Run via `node --test tests/designer/test-dispatch-peer.mjs`.
...
const DISPATCH_PATH = resolve(REPO_ROOT, 'plugins/designer/scripts/dispatch-peer.mjs');
