// plugins/founder/scripts/dispatch-peer.mjs unit tests (Stage 2
...
//
// Run via `node --test tests/founder/test-dispatch-peer.mjs`.
...
const DISPATCH_PATH = resolve(REPO_ROOT, 'plugins/founder/scripts/dispatch-peer.mjs');
