...
const PRESENCE_KEYS = [
  ...
  'config', 'companion_settings', 'notify_settings', 'session_settings', 'session_readiness', 'mutation_boundary', 'artifacts', 'limits', 'overall',
...
describe('runtime settings probe boundary (--skip-host-cli-probes)', () => {
  it('runs zero host-CLI probes and resolves model/effort from the filesystem', async () => {
    ...
    strictEqual(SETTINGS_SCHEMA_VERSION, 'runtime-settings-1.21');
  });
