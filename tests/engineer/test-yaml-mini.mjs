// Tests for plugins/engineer/scripts/lib/yaml-mini.mjs — vendor minimal
// YAML parser for the engineer:decide registry. Covers happy parsing
// + every reject case the schema's failure-mode table relies on.

import { test } from "node:test";
import { strict as assert } from "node:assert";
import { parse, YamlParseError } from "../../plugins/engineer/scripts/lib/yaml-mini.mjs";
