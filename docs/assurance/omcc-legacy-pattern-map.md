...
Evidence paths refreshed: 2026-09-23 — the Replacement evidence column
now names engineer's relocated skill tree
(`plugins/engineer/core/skills/`, per the 2026-09-18 Amendment to
[ADR-0006](../adr/0006-directory-layout-install-pattern.md)), and three
paths that never existed were corrected (D15, D18). Dispositions and
statuses were not re-reviewed.
...
| D15 | Framework docs: orchestration, taxonomy, ensemble, presentation, continuity | `../omcc/plugins/omcc-dev/orchestration.md`; `agent-taxonomy.md`; `ensemble-protocol.md`; `presentation-protocol.md`; `continuity-protocol.md` | Concepts were split into ADR-backed layer boundaries, shared references, and per-plugin skills instead of one large plugin-local framework. | `docs/ARCHITECTURE.md`; `docs/adr/0010-plugin-boundary-policy.md`; `docs/adr/0018-stage3-architecture-orchestrator-and-branch-context.md`; `plugins/engineer/core/skills/_shared/references/`; `plugins/orchestrator/core/skills/_shared/references/` | improved | Active daily workflow reads agentic-plugins docs and skills. |
...
| D18 | `omcc-research` handoff into `research_brief.md` | `../omcc/plugins/omcc-research` | The standalone research plugin pattern was retired; cited brief behavior moved into engineer investigate. | `docs/adr/0014-plugins-research-deprecation.md`; `docs/adr/0015-research-archive-timeline-collapse.md`; `plugins/engineer/core/skills/investigate/SKILL.md`; `tests/engineer/test-cited-brief.mjs` | improved | Active daily workflow has direct replacement through engineer investigate. |
