...
against the installed `plugin-runtime` `0.88.0` state (`claude plugin list`
reports the runtime plugin enabled at 0.88.0 with its Claude cache at 0.88.0,
and `codex plugin list --json` reports it installed and enabled at 0.88.0 —
claude=installed/0.88.0, codex=installed/0.88.0 — per the 2026-08-02Z
`doctor-20260802T132248Z-2b8a4c` read; this loop refreshed both hosts host-
...
native to the installed `plugin-runtime` `0.88.0`: permission proof, deep peer
smoke, and workflow continuation proof executed and passed in both directions,
recorded on 2026-08-02Z as `doctor-20260802T132248Z-2b8a4c` — the **one
...
The latest `plugin-runtime` `0.88.0` release/install proof loop is the **one
machine snapshot per verb** slice, whose 0.87.0-native proof
