...
plugin-management recommendations after the `plugin-runtime` `0.58.1` release
and installed-state refresh. Current runtime execution evidence on 2026-05-17 KST
from installed `plugin-runtime` `0.58.1` reports permission proof, deep peer
...
The `plugin-runtime` `0.58.1` release/install proof loop is carried by PR #333
and release PR #334, release tags `plugin-engineer-v0.12.1`,
`plugin-orchestrator-v0.7.3`, and `plugin-runtime-v0.58.1`, marketplace sync
commit `71bf91f`, settings artifact `settings-20260517T052535Z-4f967d`, and
proof doctor artifact `doctor-20260517T052823Z-e7c7b7`.
