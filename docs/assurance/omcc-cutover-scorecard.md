...
from installed `plugin-runtime` `0.60.0` reports permission proof, deep peer
...
commit `ff32a1b`, settings artifact `settings-20260517T070903Z-ab7946`, and
proof doctor artifact `doctor-20260517T070928Z-070bc2`. The Codex hook wrapper
...
PR #342 adds the cutover operator-verification checklist that turns stale hook
