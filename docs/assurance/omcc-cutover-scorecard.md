...
Current local dry-run evidence: a fresh 2026-07-23Z `runtime:settings` dry-run
...
`0.86.0` = installed `0.86.0` on both hosts), and zero plugin-management
config writes planned against the installed `plugin-runtime` `0.86.0` state
(both the Claude plugin cache and `codex plugin list --json` report the
runtime plugin installed and enabled at 0.86.0 — claude=installed/0.86.0,
codex=installed/0.86.0 — per the 2026-07-23Z `doctor-20260723T124714Z-a2e2e0`
...
`plugin-runtime` `0.86.0`: permission proof, deep peer smoke, and workflow
continuation proof executed and passed in both directions, recorded on
2026-07-23Z as `doctor-20260723T124714Z-a2e2e0` — the **ADR-0048
...
#629 3615dcc; release PR #630 `chore: release main` squash `1b6c569`, tag
`plugin-runtime-v0.86.0`, marketplace sync `17e96d6`; Claude Code `2.1.218` /
...
The latest `plugin-runtime` `0.86.0` release/install proof loop is the
...
main`, squash `1b6c569`) cut tag `plugin-runtime-v0.86.0` with marketplace
sync commit `17e96d6`, and the 0.86.0-native proof
doctor-20260723T124714Z-a2e2e0 (2026-07-23Z; `overall` `pass`, three execute
