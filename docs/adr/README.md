...
| [0037](0037-image-capability-plugin.md) | `image` capability plugin (L2) — cross-host image generation: Codex-native gpt-image + Claude-via-`codex-companion` bridge (shared-fs artifact, text pointer), compose-centric verbs, domains-as-profiles; applies ADR-0010 §6 Trigger 2 + §7; feasibility spike confirmed | Proposed |
