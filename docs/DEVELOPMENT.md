...
> `plugin-runtime` v0.27.0, runtime ships `doctor`, `settings` with
> explicit plugin-management execution artifacts plus narrow Codex
...
> are historical ADR-0024 dogfood datapoints; the later v0.27.0 closeout
