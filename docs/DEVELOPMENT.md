...
> `plugin-runtime` v0.27.1, runtime ships `doctor`, `settings` with
> explicit plugin-management execution artifacts, semantic failure
> classification for unavailable host plugin surfaces, narrow Codex
...
> are historical ADR-0024 dogfood datapoints; the later v0.27.1 closeout
