...
> `plugin-runtime` v0.27.5, runtime ships `doctor`, `settings` with
...
> manual follow-up checklists for host-native `/plugin ...` commands
> surfaced from both settings and doctor,
