...
> localization, the founder sidecar emitter shipped via
> `plugin-founder-v0.4.0` (ADR-0043 S3) and the designer emitter remaining
> the persona-side S4 follow-up per ADR-0043 §2), runtime ships `doctor`, `settings` with
