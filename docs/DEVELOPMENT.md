...
> `plugin-runtime` v0.31.7, runtime ships `doctor`, `settings` with
...
> command-portability warnings for Codex-exposed hooks that still resolve
> through Claude-specific adapter paths, artifact-only operator attestation
