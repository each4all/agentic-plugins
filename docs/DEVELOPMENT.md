...
> `plugin-runtime` v0.42.0, runtime ships `doctor`, `settings` with
...
> `plugin_hooks` host-config apply, consensus artifacts with quality-first policy
