...
> `plugin-runtime` v0.79.0 (ADR-0040 operator observability: the
...
> localization, founder/designer sidecar emitters remaining persona-side
> follow-ups per ADR-0043 §2), runtime ships `doctor`, `settings` with
