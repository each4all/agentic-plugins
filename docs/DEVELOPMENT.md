...
> fired. Evidence accumulation toward condition 3 satisfaction begins
> with the first non-trivial engineer-driven workflow that completes
> via `/engineer:start` without `omcc-dev` escape hatch. Detailed
