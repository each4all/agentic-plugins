...
> `plugin-runtime` v0.78.0 (ADR-0040 operator observability: the
...
> `plugins/runtime/docs/settings-report-contract.md`), runtime ships `doctor`, `settings` with
