...
> `plugin-runtime` v0.45.0, runtime ships `doctor`, `settings` with
...
> pattern-map checking, and explicit dogfood evidence recording, runtime artifact
> inventory, and an
