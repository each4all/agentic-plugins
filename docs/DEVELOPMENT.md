...
> `plugin-runtime` v0.11.0, runtime ships `doctor`, `settings` with
...
> is recorded as an early ADR-0024 dogfood datapoint, but it does not by
> itself satisfy ADR-0012 condition 3. `plugins/designer` remains
